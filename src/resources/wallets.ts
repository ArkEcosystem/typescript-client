...
import { AllWalletsApiQuery, SearchWalletsApiBody, WalletsTransactionsApiQuery, WalletsTransactionsReceivedApiQuery, WalletsTransactionsSentApiQuery } from "../resourcesTypes/wallets";
...
export class Wallets extends Resource {
	 ...
	 * @param addressOrPublicKey The identifier of the wallet to be retrieved.
	 */
	public async transactions<T = any>(addressOrPublicKey: string, query?: WalletsTransactionsApiQuery): Promise<IResponse<T>> {
	 ...
	 * @param addressOrPublicKey The identifier of the wallet to be retrieved.
	 */
	public async transactionsReceived<T = any>(addressOrPublicKey: string, query?: WalletsTransactionsReceivedApiQuery): Promise<IResponse<T>> {
	 ...
	 * @param addressOrPublicKey The identifier of the wallet to be retrieved.
	 */
	public async transactionsSent<T = any>(addressOrPublicKey: string, query?: WalletsTransactionsSentApiQuery): Promise<IResponse<T>> {
