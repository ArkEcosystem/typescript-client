...
module.exports = class ApiClient {
  ...
  peers () {
    return new Peers(this.http)
  }

  blocks () {
    return new Blocks(this.http)
  }

  delegates () {
    return new Delegates(this.http)
  }

  node () {
    return new Node(this.http)
  }

  transactions () {
    return new Transactions(this.http)
  }

  votes () {
    return new Votes(this.http)
  }

  wallets () {
    return new Wallets(this.http)
  }
